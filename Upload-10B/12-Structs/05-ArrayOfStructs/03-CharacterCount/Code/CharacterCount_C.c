...
struct CharacterCount
{
	...
	int ch_count;
						...
						{'E', 0}, // character_and_count[3].ch = 'D' & character_and_count[3].ch_count = 0
						{'F', 0},
						{'G', 0},
						{'H', 0},
						{'I', 0},
...
int main(void)
{
	...
	printf("%s\n\n", str);
		...
		for (i = 0; i < actual_string_length; i++)
		{
			...
			{
				str[i] = toupper(str[i]); // If input character is in lower case, turn it to upper case for comparision
