...
#include "OGL.h"
	...
	//Assignment 14/16
	/*Assignment 15:
	- Draw a big hollow triangle at the center.
	- Draw a circle inside the triangle.
	- Vertical line perpendicular draw from apex of triangle to
	the base of triangle. (this is static deathly hallows)
	- Color yellowish gold/yellow.*/
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	//create window
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("NKK OGL - Assignment 15/16"), WS_OVERLAPPEDWINDOW, (xPos - (WIN_WIDTH / 2)),
...
void display(void)
{
	...
	drawHollowTriangle(0.0f, 0.0f, 1.0f);

	glLoadIdentity();
	//Translate triangle Backwards by Z (consider Z is depth)
	glTranslatef(0.0f, 0.0f, -6.0f);
	drawHollowCircle(0.0f, -0.38f, 0.60f);
