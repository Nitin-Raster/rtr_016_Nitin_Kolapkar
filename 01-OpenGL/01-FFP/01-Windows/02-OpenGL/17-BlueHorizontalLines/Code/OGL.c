...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	//create window
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("NKK OGL - Assignment 4/16"), WS_OVERLAPPEDWINDOW, (xPos - (WIN_WIDTH / 2)),
...
void display(void)
{
	...
	//Assignment 4/16
	/*Assignment 4:
	- Use base code of assignment 2 i.e x-axis
	- Draw 20 horizontal lines above and 20 below the red
	x-axis
	- Color will be blue and will have less width than the red
	line.
