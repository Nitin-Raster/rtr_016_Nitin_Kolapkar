...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	//create window
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("NKK OGL - Depth Template with Rectangle"), WS_OVERLAPPEDWINDOW, (xPos - (WIN_WIDTH / 2)),
...
{
	//code
	angleRectangle = angleRectangle + 0.09f;
