...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	//create window
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("NKK OGL - Assignment 3/16"), WS_OVERLAPPEDWINDOW, (xPos - (WIN_WIDTH / 2)),
...
void display(void)
{
	...
	//Assignment 3/16
	/*Assignment 3:
	- Vertically Centered line dividing the screen
	- Green color line and having the same thickness as the
	red line.
	- This is the y-axis from -ve to +ve y.*/
	glPointSize(1.0f);
	glBegin(GL_POINTS);
	glColor3f(0.0f, 1.0f, 0.0f); //r, g, b
	float fPointCounterY = 0.0f;
	for (fPointCounterY = -5.0f; fPointCounterY <= 5.0f; fPointCounterY = fPointCounterY + 0.001f)
	{
		glVertex3f(0.0f, fPointCounterY, 0.0f);
	}
