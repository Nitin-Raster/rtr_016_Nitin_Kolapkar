...
#include <gl/GLU.h> //Backward slash also works but all compilers we use forward slash for linux and Mac and other OS //6th April 2025
...
#pragma comment(lib, "GLU32.lib") //For Perspective and for Sphere //6th April 2025
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	//create window
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("NKK OGL - 3D Pyramid 22nd March 2025"), WS_OVERLAPPEDWINDOW, (xPos - (WIN_WIDTH / 2)),
...
void display(void)
{
	...
	glTranslatef(0.0f, 0.0f, -12.0f); //Adjust -12 later 
	...
	//Code For Arm
	//
	glRotatef((GLfloat)shoulder, 0.0f, 0.0f, 1.0f); //Shoulder degree ne rotate
	glTranslatef(1.0f, 0.0f, 0.0f); //Translate ho x axis la
	glPushMatrix();
	...
	//Common to both Arm and ForeArm
	glPopMatrix();
