...
#include "OGL.h"
	...
	//Assignment 11/16
	/*Assignment 11:
	- Draw kundali blank shape.
	- Orange color for lines (on black background as before)
	- Thickness should be same as red line in assignment 2*/
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	//create window
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("NKK OGL - Assignment 11/16"), WS_OVERLAPPEDWINDOW, (xPos - (WIN_WIDTH / 2)),
