...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	//create window
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("NKK OGL - Assignment 8/16"), WS_OVERLAPPEDWINDOW, (xPos - (WIN_WIDTH / 2)),
...
void display(void)
{
	...
	//Assignment 8/16
	/*Assignment 8:
	- Use assignment 6 as base code and draw a hollow
	square at the center.
	- Color yellow. Thickness should be the same as blue
	lines.*/
