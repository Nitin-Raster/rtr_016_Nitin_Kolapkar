...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	//create window
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("NKK OGL - Assignment 6/16"), WS_OVERLAPPEDWINDOW, (xPos - (WIN_WIDTH / 2)),
...
void display(void)
{
	...
	//Assignment 6/16
	/*Assignment 6:
	This will be the combination of assignment 4 and
	assignment 5. (graph paper)*/
	//glPointSize(1.0f);
	glLineWidth(1.0f);
