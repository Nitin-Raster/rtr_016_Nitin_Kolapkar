...
//This header must be include HL.H
#include <gl/GLEW.h>
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	//create window
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("NKK OGL - PP Bluescreen with Empty Shaders 22nd June"), WS_OVERLAPPEDWINDOW, (xPos - (WIN_WIDTH / 2)),
...
int initialize(void)
{
	...
	*/
	...
	glClearColor(0.0f, 0.0f, 1.0f, 1.0f); //set black color
