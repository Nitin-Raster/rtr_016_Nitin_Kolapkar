...
//mat4 orthographicProjectionMatrix;  //vmath::mat4 matrix 4X4
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	//create window
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("NKK OGL - PP ORTHO Trangle with Shaders 29th June"), WS_OVERLAPPEDWINDOW, (xPos - (WIN_WIDTH / 2)),
...
int initialize(void)
{
	...
	*/
	...
	glBindBuffer(GL_ARRAY_BUFFER, vbo_color); //binding point (it can have multiple binding points)
	...
	//29th June
	//orthographicProjectionMatrix = mat4::identity(); //this is analogus to FFP's glLoadIdentity()
