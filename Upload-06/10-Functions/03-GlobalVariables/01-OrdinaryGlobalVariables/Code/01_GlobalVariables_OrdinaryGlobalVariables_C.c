...
// If not initialized by us, global variables are not initialized to their zero values (with respect to their data types i.e.: 0 for int, 0.0 for float and double, etc.) by default
