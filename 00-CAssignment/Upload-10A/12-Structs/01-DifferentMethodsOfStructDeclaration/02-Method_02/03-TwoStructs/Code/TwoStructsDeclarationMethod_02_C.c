...
struct MyPoint point_nkk; // Declaring a single variable of type 'struct MyPoint' globally...
struct MyPointProperties point_properties_nkk; // Declaring a signle variable of type 'struct MyPointProperties' globally...
