...
int main(void)
{
	...
	printf("\n\n");
	printf("******** USING ARRAY NAME AS A POINTER i.e. Value Of xth Element If iArray : *(iArray + x ) AND Address Of xth Element Of iArray : ( iArray + x ) ********\n\n");
	...
	// ######## USING POINTER AS ARRAY NAME i.e. Value Of xth Element Of iArray : ptr_iArray[x] AND Addresses Of xth Element Of iArray : &ptr_iArray[x] ########
	printf("\n\n");
