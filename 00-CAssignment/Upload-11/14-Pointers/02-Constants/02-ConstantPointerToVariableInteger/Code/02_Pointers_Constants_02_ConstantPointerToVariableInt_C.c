...
int main(void)
{
	...
	int num_nkk = 5;
	int* const ptr_nkk = &num_nkk; // Read this line from right to left => "ptr is a constant (const) pointer (*) to integer (int)"
...
// We can also change the "the value at address of ptr" - we can change the value of "num" with respect to "ptr" => (*ptr)++ is allowed
