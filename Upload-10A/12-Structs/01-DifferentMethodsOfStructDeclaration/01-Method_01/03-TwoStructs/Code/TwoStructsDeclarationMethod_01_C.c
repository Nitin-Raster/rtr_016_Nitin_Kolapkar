...
struct MyPoint
{
	int x;
	int y;
} point_nkk; // Declaring a single struct variable of type 'struct MyPoint' globally ...
...
}point_properties_nkk; //declaring a single variable of tyoe 'struct MyPointProperties' globally
